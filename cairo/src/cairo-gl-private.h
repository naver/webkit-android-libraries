...
typedef struct _cairo_gl_dispatch {
    /* Buffers */
    void (EGLAPIENTRY *GenBuffers) (GLsizei n, GLuint *buffers);
    void (EGLAPIENTRY *BindBuffer) (GLenum target, GLuint buffer);
    void (EGLAPIENTRY *BufferData) (GLenum target, GLsizeiptr size,
			  const GLvoid* data, GLenum usage);
    GLvoid *(EGLAPIENTRY *MapBuffer) (GLenum target, GLenum access);
    GLboolean (EGLAPIENTRY *UnmapBuffer) (GLenum target);

    /* Shaders */
    GLuint (EGLAPIENTRY *CreateShader) (GLenum type);
    void (EGLAPIENTRY *ShaderSource) (GLuint shader, GLsizei count,
			    const GLchar** string, const GLint* length);
    void (EGLAPIENTRY *CompileShader) (GLuint shader);
    void (EGLAPIENTRY *GetShaderiv) (GLuint shader, GLenum pname, GLint *params);
    void (EGLAPIENTRY *GetShaderInfoLog) (GLuint shader, GLsizei bufSize,
				GLsizei *length, GLchar *infoLog);
    void (EGLAPIENTRY *DeleteShader) (GLuint shader);

    /* Programs */
    GLuint (EGLAPIENTRY *CreateProgram) (void);
    void (EGLAPIENTRY *AttachShader) (GLuint program, GLuint shader);
    void (EGLAPIENTRY *DeleteProgram) (GLuint program);
    void (EGLAPIENTRY *LinkProgram) (GLuint program);
    void (EGLAPIENTRY *UseProgram) (GLuint program);
    void (EGLAPIENTRY *GetProgramiv) (GLuint program, GLenum pname, GLint *params);
    void (EGLAPIENTRY *GetProgramInfoLog) (GLuint program, GLsizei bufSize,
				 GLsizei *length, GLchar *infoLog);

    /* Uniforms */
    GLint (EGLAPIENTRY *GetUniformLocation) (GLuint program, const GLchar* name);
    void (EGLAPIENTRY *Uniform1f) (GLint location, GLfloat x);
    void (EGLAPIENTRY *Uniform2f) (GLint location, GLfloat x, GLfloat y);
    void (EGLAPIENTRY *Uniform3f) (GLint location, GLfloat x, GLfloat y, GLfloat z);
    void (EGLAPIENTRY *Uniform4f) (GLint location, GLfloat x, GLfloat y, GLfloat z,
			 GLfloat w);
    void (EGLAPIENTRY *UniformMatrix3fv) (GLint location, GLsizei count,
				GLboolean transpose, const GLfloat *value);
    void (EGLAPIENTRY *UniformMatrix4fv) (GLint location, GLsizei count,
			      GLboolean transpose, const GLfloat *value);
    void (EGLAPIENTRY *Uniform1i) (GLint location, GLint x);

    /* Attributes */
    void (EGLAPIENTRY *BindAttribLocation) (GLuint program, GLuint index,
				const GLchar *name);
    void (EGLAPIENTRY *VertexAttribPointer) (GLuint index, GLint size, GLenum type,
				 GLboolean normalized, GLsizei stride,
				 const GLvoid *pointer);
    void (EGLAPIENTRY *EnableVertexAttribArray) (GLuint index);
    void (EGLAPIENTRY *DisableVertexAttribArray) (GLuint index);

    /* Framebuffer objects */
    void (EGLAPIENTRY *GenFramebuffers) (GLsizei n, GLuint* framebuffers);
    void (EGLAPIENTRY *BindFramebuffer) (GLenum target, GLuint framebuffer);
    void (EGLAPIENTRY *FramebufferTexture2D) (GLenum target, GLenum attachment,
				    GLenum textarget, GLuint texture,
				    GLint level);
    GLenum (EGLAPIENTRY *CheckFramebufferStatus) (GLenum target);
    void (EGLAPIENTRY *DeleteFramebuffers) (GLsizei n, const GLuint* framebuffers);
    void (EGLAPIENTRY *GenRenderbuffers) (GLsizei n, GLuint *renderbuffers);
    void (EGLAPIENTRY *BindRenderbuffer) (GLenum target, GLuint renderbuffer);
    void (EGLAPIENTRY *RenderbufferStorage) (GLenum target, GLenum internal_format,
				 GLsizei width, GLsizei height);
    void (EGLAPIENTRY *FramebufferRenderbuffer) (GLenum target, GLenum attachment,
				     GLenum renderbuffer_ttarget, GLuint renderbuffer);
    void (EGLAPIENTRY *DeleteRenderbuffers) (GLsizei n, GLuint *renderbuffers);
    void (EGLAPIENTRY *BlitFramebuffer) (GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1,
			     GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1,
			     GLbitfield mask, GLenum filter);
    void (EGLAPIENTRY *RenderbufferStorageMultisample) (GLenum target, GLsizei samples,
					    GLenum internalformat,
					    GLsizei width, GLsizei height);
    void (EGLAPIENTRY *FramebufferTexture2DMultisample) (GLenum target, GLenum attachment,
					     GLenum textarget, GLuint texture,
