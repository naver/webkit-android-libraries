                               ...
                               unsigned int        vertex_offset)
{
    ...
    case CAIRO_GL_OPERAND_TEXTURE:
        return dest->texture.surface != source->texture.surface ||
               ...
               dest->texture.attributes.matrix.x0 != source->texture.attributes.matrix.x0 ||
               dest->texture.attributes.matrix.xx != source->texture.attributes.matrix.xx ||
               dest->texture.attributes.matrix.xy != source->texture.attributes.matrix.xy ||
               dest->texture.attributes.matrix.y0 != source->texture.attributes.matrix.y0 ||
               dest->texture.attributes.matrix.yx != source->texture.attributes.matrix.yx ||
               dest->texture.attributes.matrix.yy != source->texture.attributes.matrix.yy;
    case CAIRO_GL_OPERAND_LINEAR_GRADIENT:
    case CAIRO_GL_OPERAND_RADIAL_GRADIENT_A0:
    case CAIRO_GL_OPERAND_RADIAL_GRADIENT_NONE:
    case CAIRO_GL_OPERAND_RADIAL_GRADIENT_EXT:
